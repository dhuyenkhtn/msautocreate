const site_config = 
{
    ...
    'code_api_link': 'http://api-keymanager.digibox.vn/',
    };

const ms_config = 
{
    'tenant_id': '26e042f5-7b80-4db4-a060-d693d3b00c62',
    'client_id': 'f6ffacef-b0a4-4859-9758-7b2eb3f3119d',
    'client_secret': 'SV-X3EV2-5HSdxg9.8Q8_NEJ1tm1cP3qwh',
    'subscriptions': 
    [
        {
        'name': 'Office 365 Enterprise E5',  //eg. Office 365 A1 for faculty
    ...
    'domains': ['skywaydev.onmicrosoft.com']
};
